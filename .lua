...
ThemeManager:SetFolder('sphinxc.priv')
SaveManager:SetFolder('sphinxc.priv/main')
...
OthersSettings:AddInput('uinamechange', {Default = 'sphinxc.priv', Numeric = false, Finished = false, Text = 'Window Title', Tooltip = 'Changes window title', Placeholder = '. . .'})
...
Library:Notify('Finished Loading! Welcome ' ..localPlayer.Name.. ' to sphinxc.priv you fucking jew!');
